...
(() => {
  ...
  // src/framework/models/ApiSync.ts
  var ApiSync = class {
    constructor(apiUrl) {
      this.apiUrl = apiUrl;
    }
  ...
  // src/framework/models/Attributes.ts
  ...
  // src/framework/models/Eventing.ts
  var Eventing = class {
    constructor() {
      this.events = {};
      // {'click': [cb1], [cb2], 'hover': [cb3]}
  ...
  // src/framework/models/Collection.ts
  var Collection = class {
    constructor(rootUrl2, deserialize) {
      this.rootUrl = rootUrl2;
  ...
  // src/models/User.ts
  var rootUrl = "http://localhost:3001/users";
  ...
  // src/index.ts
  var user = User.buildUser({ name: "Kim", age: 26 });
